        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" style={{ color:"black" }}>
              ...
              &nbsp; like
              <i>
                <b className="purple"> Basic React.js </b>
              </i>
            </p>
          </Col>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/chandrakanthreddybhumireddy"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/Chandrakan92637"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/bhumireddi/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/chandrakanthreddy6/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
